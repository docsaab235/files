...
function loadtoc(json) {
   ...
   // this functions reads all postdata from the json-feed and stores it in arrays
      if ("entry" in json.feed) {
         ...
         nextjsoncall.setAttribute("src", "http://pjoshi235.blogspot.com/feeds/posts/summary?start-index=" + startindex + "&max-results=500&alt=json-in-script&callback=loadtoc");
...
// this function creates a three-column table and adds it to the screen
   ...
   for (var i = 0; i < postTitle.length; i++) {
      if (filter == '') {
         tocTable += '<table class="postdata"><tbody><tr><td class="toc-entry-col1"><a href="' + postUrl[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col2">' + postDate[i] + '</td></tr></tbody></table>';
         numDisplayed++;
      } else {
