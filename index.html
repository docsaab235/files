...
<div align=center>
 <script language="Javascript">
    ...
    document.write("Welcome to our visitors from: ");  
    document.write(" "+geoplugin_city()+", "+geoplugin_countryName()); 
	document.write("</div>"); 
</script>
 
 <div style="margin-top:15px; margin-bottom:15px;">
<iframe align='center' frameborder='0' height='25px' id='' name='target' src='http://pshow.c1.biz/iplookup.php' width='450px'></iframe>
</div>
 
 
  <script language="Javascript">
    document.write("<div id=r2>"); 
	document.write("Your longitude & Latitude: "); 
	document.write(" "+geoplugin_longitude()+" & "+geoplugin_latitude()); 
    document.write("</div>"); 
 </script>
